    ...
    const partners = [
        {
            ...
            description: "Stellantis deploys Advanced Intelligence in Motion Forge across multinational brands, business functions and plant locations to accelerate its digital transformation, including improving supply chain performance, enhancing vehicle quality, and accelerating speed of delivery.",
        ...
        },
        {
            ...
            description: "With billions of vehicle configuration and performance datapoints, J.D. Power leverages Advanced Intelligence in Motion AIP and Forge to operationalize this hyper-scale information and support the development of new analytics models and workflow solutions.",
                ...
                <div className="flex flex-col md:flex-row justify-between items-start gap-16">
                    ...
                    <div className="flex flex-col items-start max-w-md pt-4">
                        ...
                        <p className="text-2xl md:text-3xl font-light leading-tight text-gray-600">
                            Advanced Intelligence in Motion and its customers are leading the charge.
                        </p>
                    </div>
                </div>
            </section>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
                    ...
                    <div className="flex flex-col gap-8">
                        <h3 className="text-3xl md:text-4xl font-light leading-tight">
                            Advanced Intelligence in Motion Forge, one of the world's leading Automotive software applications, is powering the mobility revolution. Most of the top 10 OEMs globally, as well as over 30 major Automotive part suppliers, use our software to analyse and understand their data.
                        </h3>
                        <div className="space-y-6 text-gray-600 text-lg leading-relaxed">
                            <p>
                                From design to assembly — through marketing, sales, and use on the road — every vehicle produces masses of data. Advanced Intelligence in Motion Forge presents an end-to-end solution for the automotive ecosystem.
                            </p>
                            <p>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-x-8 gap-y-16">
                    ...
                    <div className="flex flex-col gap-4">
                        <div className="flex items-center gap-2 mb-4">
                            ...
                            <div className="text-xl leading-tight">Advanced Intelligence in Motion <br /> QMOS</div>
                        </div>
                    ...
                    <div className="flex flex-col gap-4">
                        <div className="flex items-center gap-2 mb-4">
                            ...
                            <div className="text-xl leading-tight">Advanced Intelligence in Motion <br /> Supply Chain</div>
                        </div>
                        <p className="text-sm text-gray-600 leading-relaxed mb-4">
                    ...
                    <div className="flex flex-col gap-4">
                        <div className="flex items-center gap-2 mb-4">
                            ...
                            <div className="text-xl leading-tight">Advanced Intelligence in Motion <br /> Plant Digital Twin</div>
                        </div>
                        <p className="text-sm text-gray-600 leading-relaxed mb-4">
                    ...
                    <div className="flex flex-col gap-4">
                        <div className="flex items-center gap-2 mb-4">
                            ...
                            <div className="text-xl leading-tight">Advanced Intelligence in Motion <br /> Complexity Reduction</div>
                        </div>
                        <p className="text-sm text-gray-600 leading-relaxed mb-4">
                    ...
                    <div className="flex flex-col gap-4">
                        <div className="flex items-center gap-2 mb-4">
                            ...
                            <div className="text-xl leading-tight">Advanced Intelligence in Motion <br /> COGS</div>
                        </div>
                        <p className="text-sm text-gray-600 leading-relaxed mb-4">
                    ...
                    <div className="flex flex-col gap-4">
                        <div className="flex items-center gap-2 mb-4">
                            ...
                            <div className="text-xl leading-tight">Advanced Intelligence in Motion <br /> New Vehicle Launch</div>
                        </div>
                        <p className="text-sm text-gray-600 leading-relaxed mb-4">
                            Advanced Intelligence in Motion Forge is built to help large organizations react to critical, time-sensitive work. From empowering smooth production ramp-ups to optimizing sales campaigns and monitoring initial in-service performance, data is at the core of ensuring the success of a new vehicle launch.
                        </p>
                        <a href="#" className="text-xs font-mono uppercase tracking-wider border-b border-gray-300 pb-1 w-fit hover:border-black transition-colors">
                            ↳ Learn more
                        </a>
                    ...
                    <div className="flex flex-col gap-4">
                        <div className="flex items-center gap-2 mb-4">
                            ...
                            <div className="text-xl leading-tight">Advanced Intelligence in Motion <br /> Net-Zero</div>
                        </div>
                        <p className="text-sm text-gray-600 leading-relaxed mb-4">
                        ...
                        <div className="flex flex-col justify-between">
                            <div>
                                ...
                                <div className="flex items-center gap-2 text-sm text-gray-500 mb-16">
                                    <span className="text-gray-400">↳</span> Shyam Sankar, Advanced Intelligence in Motion CTO
                                </div>
                            </div>
                        ...
                        <div className="flex flex-col justify-between">
                            <div>
                                <div className="text-2xl md:text-3xl font-light leading-tight mb-8">
                                    ...
                                    <br /><br />
                                    Advanced Intelligence in Motion will continue to provide us with superior value service over the competition through their differentiated technology prowess. We hope the success of our joint project will be utilized as a reference point for many other companies in Korea's domestic manufacturing industry.
                                </div>
                                <div className="flex items-center gap-2 text-sm text-gray-500 mb-16">
                            ...
                            <div className="space-y-8">
                                ...
                                <div className="grid grid-cols-[120px_1fr] gap-8 border-t border-gray-200 pt-8">
                                    <div className="text-xs font-bold text-gray-400 uppercase tracking-widest">Solution</div>
                                    <div className="text-lg text-gray-600">Since 2019, Advanced Intelligence in Motion and Doosan Infracore have partnered to drive digital transformation and deliver high-quality, market-relevant products to its customers.</div>
                                </div>
                                <div className="grid grid-cols-[120px_1fr] gap-8 border-t border-gray-200 pt-8">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 animate-fade-in">
                        <div className="flex flex-col justify-between">
                            ...
                            <div className="space-y-8">
                                ...
                                <div className="grid grid-cols-[120px_1fr] gap-8 border-t border-gray-200 pt-8">
                                    <div className="text-xs font-bold text-gray-400 uppercase tracking-widest">Solution</div>
                                    <div className="text-lg text-gray-600">Built on top of Forvia's IT portfolio and contracted cloud services, Advanced Intelligence in Motion Forge allows Forvia to reduce raw material consumption, improve R&D competitiveness, secure purchasing excellence and track and measure overall CO2 neutrality efforts. The applications built on the data platform will contribute to generate digital twins, thus also enabling Forvia's capabilities to proactively simulate variability.</div>
                                </div>
                                <div className="grid grid-cols-[120px_1fr] gap-8 border-t border-gray-200 pt-8">
                                    <div className="text-xs font-bold text-gray-400 uppercase tracking-widest">Impact</div>
                                    <div className="text-lg text-gray-600">

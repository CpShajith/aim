            ...
            <div className="max-w-7xl mx-auto px-6 z-10 w-full">
                ...
                >
                    ...
                    <p className="text-xl text-gray-400 max-w-2xl mb-12 leading-relaxed">
                        AIP provides the primitives you need to build LLM-powered applications.
                ...
                >
                    <div className="h-10 bg-[#151515] flex items-center px-4 gap-2 border-b border-white/5">
                        ...
                        <div className="ml-4 text-xs text-gray-500 font-mono">aip_pipeline.tsx — AIP Developer Console</div>
                    </div>
                    <div className="aspect-[16/9] relative">
                        ...
                        <div className="absolute top-12 left-12 right-12 bottom-12 bg-black/80 backdrop-blur-md rounded border border-white/10 p-6 font-mono text-sm overflow-hidden hidden md:block">
                            <div className="text-pink-400">import</div> <div className="text-white inline">{`{ Agent, Ontology }`}</div> <div className="text-pink-400 inline">from</div> <div className="text-green-400 inline">'@AIM/aip'</div>;
                            <br /><br />
        ...
        <Section className="bg-[#050505] border-t border-white/10">
            <div className="mb-16">
                ...
                <p className="text-gray-400 max-w-2xl text-lg">
                    Don't change your workflow. AIP integrates directly into your existing development environment and pipelines.
                </p>
            </div>
            ...
            <div className="flex flex-col lg:flex-row items-center gap-16">
                <div className="flex-1">
                    ...
                    <p className="text-lg text-gray-400 mb-12">
                        The AIP Stack provides a unified architecture for logic, data, and action.
                    </p>
        ...
        <div className="bg-[#0A0A0A] py-32 px-6">
            <div className="max-w-7xl mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    {[
                        { title: '1. Prototype', desc: 'Build locally with the AIP extension for VS Code.', icon: FaCode },
...
const CompareTable = () => {
    return (
        <Section className="bg-[#050505]">
            <h2 className="text-4xl font-bold text-white mb-16 text-center">Why developers choose AIP</h2>
            <div className="overflow-x-auto">
                <table className="w-full text-left border-collapse">
                    <thead>
                        <tr className="border-b border-white/10">
                            <th className="py-6 px-4 text-gray-500 font-normal uppercase tracking-widest text-sm">Feature</th>
                            <th className="py-6 px-4 text-blue-400 font-bold text-xl">AIP</th>
...
const AIPForDevelopers = () => {
    return (
        <div className="bg-[#050505] min-h-screen">
            ...
            <FeatureSection
                title="Ontology"
                desc="Don't feed your LLMs raw text. Bind them to a living digital twin of your organization. AIP Ontology provides the semantic layer that gives models deep understanding."
            ...
            <FeatureSection
                title="Actions"
                desc="Safely write back to your systems. AIP handles the 'last mile' problem of determining which actions to take and executing them securely."
...
export default AIPForDevelopers;
